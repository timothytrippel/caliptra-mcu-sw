...
use crate::vdm_handler::iana::ocp::caliptra_vdm::commands::get_debug_log::MAX_LOG_DATA_SIZE;
...
#[repr(C)]
struct GetAttestationLogReq {}

impl CommonCodec for GetAttestationLogReq {}

pub(crate) async fn handle_get_attestation_log(
    ...
    match handler
        .get_log(LogType::Attestation as u32, &mut scratch)
        .await
    {
        Ok(GetLogResult {
            bytes_written,
