...
pub struct Fuses {
    ...
    pub secret_manuf_partition: [u8; 80],

    /// Secret production partition 0.
    pub secret_prod_partition_0: [u8; 24],

    /// Secret production partition 1.
    pub secret_prod_partition_1: [u8; 24],

    /// Secret production partition 2.
    pub secret_prod_partition_2: [u8; 24],

    /// Secret production partition 3.
    pub secret_prod_partition_3: [u8; 24],
...
impl Default for Fuses {
    fn default() -> Self {
        Self {
            ...
            secret_manuf_partition: [0; 80],
            secret_prod_partition_0: [0; 24],
            secret_prod_partition_1: [0; 24],
            secret_prod_partition_2: [0; 24],
            secret_prod_partition_3: [0; 24],
