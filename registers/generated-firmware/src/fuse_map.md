...
| 33 | CPTRA_CORE_VENDOR_PK_HASH_VALID | 0x077c | 16 | LinearMajorityVote(3x) |
...
| vendor_pk_hash_valid | 16 | VENDOR_HASHES_PROD_PARTITION | CPTRA_CORE_VENDOR_PK_HASH_VALID | LinearMajorityVote(3x) | Bitmask of valid vendor PK hash slots. |
